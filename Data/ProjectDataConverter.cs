...
public static class ProjectDataConverter
{
    ...
    private static void RegisterEntitySerializers()
    {
        ...
        RegisterEntitySerializer<SegmentEntity, LineEntityData>(entity => new LineEntityData { Id = entity.Id, Position = entity.Position.ToPointData(), SecondPosition = entity.Children[1].Position.ToPointData() });
    ...
    private static void RegisterEntityDeserializers()
    {
        ...
        RegisterEntityDeserializer<LineEntityData, SegmentEntity>(entityData => new SegmentEntity(entityData.Position.ToPoint(), entityData.SecondPosition.ToPoint()) { Id  = entityData.Id });
